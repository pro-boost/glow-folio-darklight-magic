  ...
  about: {
    ...
    services: {
      frontend: {
        ...
        description: "Je me spécialise dans la création d'applications web modernes et responsives avec React et TypeScript, en mettant l'accent sur la performance, l'évolutivité et l'expérience utilisateur.",
      },
      design: {
      ...
      performance: {
        ...
        description: "J'optimise les applications web pour la rapidité et l'efficacité grâce à des techniques telles que le chargement différé et le découpage du code, afin d'améliorer les temps de chargement et l'interaction utilisateur.",
      },
    },
  },
  ...
  testimonials: {
    ...
    items: {
      yassine: {
        ...
        content: "Travailler avec ce développeur a été une expérience exceptionnelle. Son expertise dans la création d'applications web performantes et intuitives est impressionnante. Il est attentif aux détails et réactif à nos retours, livrant un travail de grande qualité.",
      },
      clara: {
        name: "Clara Dupont",
        role: "Développeuse principale",
        company: "TechWave",
        content: "Ce développeur allie maîtrise technique et passion pour le design. Ses contributions à notre plateforme e-commerce ont considérablement amélioré notre processus de développement et l'expérience utilisateur. Toujours fiable et innovant !",
      },
      marco: {
        name: "Marco Rossi",
        role: "Designer UX/UI",
        company: "Pixelate Studios",
        content: "J'ai collaboré avec de nombreux développeurs, mais celui-ci se démarque. Sa capacité à transformer des concepts complexes en code fluide est remarquable. Le résultat : un design réactif et homogène sur tous les appareils.",
      },
    },
  },
